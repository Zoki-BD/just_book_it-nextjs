...
const Profile = () => {
   ...
   //Ovde preku useEffect gi popolnuvame polinjata so prethodni podatoci(prethodno idevme se hook za ova vidi vo boutique)
   useEffect(() => {
               ...
               <div className="row wrapper">
                  <div className="col-10 col-lg-5">
                     <form className="shadow-lg" onSubmit={submitHandler}>
                        ...
                        <Link href='/' passHref className='text-center'>
                           <a > Back</a>
                        </Link>
                     </form>
                  </div>
